...
import com.notnotme.brewdog_recipes.controller.application.storage.realm.RealmDataControllerImpl;
...
public final class Application extends android.app.Application {
    ...
    public void onCreate() {
        ...
        try {
            ControllerProvider.registerController(this, StorageController.class, RealmDataControllerImpl.class);
